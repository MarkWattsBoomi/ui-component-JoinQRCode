...
export class FlowBaseComponent extends React.Component<IComponentProps, any, any> {
    ...
    constructor(props: any) {
        ...
        this.dontGetValues = this.dontGetValues.bind(this);
    ...
    async setStateValue(value: string | boolean | number | Date | FlowObjectData | FlowObjectDataArray) {
        ...
        switch (flowModel.contentType) {
            case 'ContentObject':
                const objectData = JSON.parse(JSON.stringify((value as FlowObjectData).iFlowObjectDataArray));
                manywho.state.setComponent(this.componentId, objectData, this.flowKey, true);
                break;

            case 'ContentList':
                const objectDataArray = JSON.parse(JSON.stringify((value as FlowObjectDataArray).iFlowObjectDataArray));
                manywho.state.setComponent(this.componentId, objectDataArray, this.flowKey, true);
                break;
